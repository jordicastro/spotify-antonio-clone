        ...
        <Dialog.Portal>
            ...
            >
                ...
                <Dialog.Close asChild>
                    <button>
                        <IoMdClose className=" text-neutral-400 hover:text-white absolute top-2 right-2 inline-flex w-5 h-5 appearance-none items-center justify-center rounded-full focus:outline-none" />
                    </button>
                </Dialog.Close>
            </Dialog.Content>
        </Dialog.Portal>
